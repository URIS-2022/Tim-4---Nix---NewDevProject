    ...
    public static class TestPodaciDB
    {
        ...
        private static void SeedData(KupacDBContext context)
        {
            ...
            if (!context.OvlascenaLica.Any())
            {
                ...
                {
                    new PravnoLice {KupacID=Guid.Parse("EF1623BF-7709-48B9-A3DC-1F4206CCF8D3"), TipKupca = TipKupca.PravnoLice, OstvarenaPovrsina = 50, ImaZabranu = false, Adresa = "Hajduk Veljka bb, Beograd ", BrojTelefona1="065874687", BrojTelefona2 = "06321458", Email = "kupac1@dot.net", BrojRacuna="123456", KontaktOsobaID = Guid.Parse("B1253021-4EFA-4CB2-9CA0-3E917A46C37D") },
                    new Kupac {KupacID=Guid.Parse("DFD83F67-8C37-4ED2-B198-13A8DD48598B"), TipKupca = TipKupca.FizickoLice, OstvarenaPovrsina = 70, ImaZabranu = false, Adresa = "Filipa Višnjiča 12, Valjevo ", BrojTelefona1="061454785", BrojTelefona2 = "06745874", Email = "kupac2@dot.net", BrojRacuna="5555456" }
                };
                ...
                context.OvlascenaLica.AddRange(
                   ...
                   new StraniDrzavljanin()
                   {
                       ...
                       Ime = "Marc",
                       Prezime = "Tomphson",
                       TipOvlascenogLica = TipOvlascenogLica.StraniDrzavljanin,
            ...
            if (!context.Kupci.Any())
            {
                ...
                {
                    new OvlascenoLice { OvlascenoLiceID = Guid.Parse("9565F329-1987-4785-9DCF-1DAE7F65A7C8"), TipOvlascenogLica = TipOvlascenogLica.SrpskiDrzavljanin, Adresa = "Cvetna 21, Leskovac"},
                    new OvlascenoLice { OvlascenoLiceID = Guid.Parse("2D5EB676-78D6-4D9D-941B-5123A5859BDF"), TipOvlascenogLica = TipOvlascenogLica.StraniDrzavljanin, Adresa = "High Hill 22200, Boston", }
                };
                ...
                {
                    new UplataDTO {UplataID=Guid.Parse("AF278076-2170-4001-BCA9-331CFD13A3C7")},
