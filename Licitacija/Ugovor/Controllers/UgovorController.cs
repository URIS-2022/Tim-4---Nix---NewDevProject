...
using Ugovor.Dtos;
using Ugovor.Models;
using Ugovor.SyncDataServices.Http;

namespace Ugovor.Controllers
{
    [ApiController]
    [Route("api/ugovori")]
    ...
    public class UgovorController : ControllerBase
    {
        ...
        public ActionResult<List<UgovorDto>> GetAll()
        {
            try
            {
                ...
                foreach (UgovorModel u in ugovori)
                {
        ...
        public ActionResult<UgovorDto> Create([FromBody] UgovorCreateDto ugovor, [FromHeader] string key)
        {
            ...
            try
            {
                var ugovorEntity = _mapper.Map<UgovorModel>(ugovor);
        ...
        public ActionResult<UgovorConfirmationDto> Update(UgovorUpdateDto ugovor, [FromHeader] string key)
        {
            ...
            try
            {
                ...
                UgovorModel ugovorEntity = _mapper.Map<UgovorModel>(ugovor);
